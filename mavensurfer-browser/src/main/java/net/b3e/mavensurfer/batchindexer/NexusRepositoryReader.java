...
import net.b3e.mavensurfer.batchindexer.nexusapi.Content;
import net.b3e.mavensurfer.batchindexer.nexusapi.ContentItem;
import net.b3e.mavensurfer.batchindexer.nexusapi.NexusBrowser;
